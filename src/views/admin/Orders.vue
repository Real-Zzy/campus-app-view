    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 5px;">
            <el-row>
                ...
                <el-input size="small" style="width: 166px;" v-model="ordersQueryDto.code" placeholder="Order ID" clearable
        ...
        <el-row style="margin: 0 22px;border-top: 1px solid rgb(245,245,245);">
            <el-table :stripe="true" :data="tableData">
                <el-table-column prop="code" width="140" label="Order ID"></el-table-column>
                ...
                <el-table-column prop="userName" width="130" label="Buyer"></el-table-column>
                <el-table-column prop="productTitle" width="168" label="Item"></el-table-column>
                <el-table-column prop="buyPrice" width="110" label="Price"></el-table-column>
                <el-table-column prop="buyNumber" width="110" label="Quantity"></el-table-column>
                <el-table-column prop="createTime" width="168" label="Time"></el-table-column>
                <el-table-column prop="detail" label="Detail"></el-table-column>
                <el-table-column label="Action" width="160">
                    <template slot-scope="scope">
                        <span class="text-button" @click="handleEdit(scope.row)">Detail</span>
