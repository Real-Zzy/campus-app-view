<template>
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 5px;">
            <el-row>
                <el-input size="small" style="width: 166px;" v-model="interactionQueryDto.productId" placeholder="Item ID"
        ...
        <el-row style="margin: 0 22px;border-top: 1px solid rgb(245,245,245);">
            <el-table :stripe="true" :data="tableData">
                <el-table-column prop="userAccount" width="168" label="Account"></el-table-column>
                ...
                <el-table-column prop="productTitle" label="Item"></el-table-column>
                <el-table-column prop="type" width="228" label="Type">
                    <template slot-scope="scope">
                        <span>{{ scope.row.type === 1 ? 'Add To Favorite' : (scope.row.type === 2 ? 'View' : '') }}</span>
                    </template>
                </el-table-column>
                <el-table-column prop="createTime" width="208" :sortable="true" label="Time"></el-table-column>
