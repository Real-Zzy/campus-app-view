    ...
    <div class="dashboard">
        <div class="left">
            ...
            <div style="width: 600px;">
                <LineChart @on-selected="onSelected" tag="Number of Newly Added Inventory Items" :values="values" :date="dates" height="400px" />
            </div>
        </div>
        <div class="right">
            <h2>Latest Item</h2>
            <el-col :span="8" v-for="(product, index) in productList" :key="index">
                <div class="item-product">
                    ...
                    <div v-if="product.bargain">
                        <span class="bargain-hover">Discountable</span>
                    </div>
